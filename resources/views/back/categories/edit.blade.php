                        ...
                        <div class="panel-body">
                            <div class="am-tabs am-margin" data-am-tabs="">
                                ...
                                <div class="am-tabs-bd">
                                    ...
                                    <form class="am-form" action="{{ route('backend::admin.categories.update', ['id' => $category->id]) }}"
                                          method="POST">
                                        {{ method_field('PUT') }}
                                        {{ csrf_field() }}
                                        <div class="am-g am-margin-top">
                                            ...
                                            <div class="am-u-sm-8 am-u-md-4">
                                                <input name="content" id="content" type="text" class="am-input-sm"
                                                       value="{{ $category->parent['content'] ? $category->parent['content'] : '无' }}"
                                                       readonly="readonly">
                                            </div>
                                            <div class="am-hide-sm-only am-u-md-6">上级分类不提供编辑</div>
                                        </div>
                                        <div class="am-g am-margin-top">
                                            <div class="am-u-sm-4 am-u-md-2 am-text-right">
                                                分类名称
                                        ...
                                        <div class="am-g am-margin-top">
                                            ...
                                            <div class="am-u-sm-8 am-u-md-4">
                                                <input name="seo_desc" id="seo_desc" type="text" class="am-input-sm"
                                                       value="{{ $category->seo_desc }}">
                                            </div>
                                            <div class="am-hide-sm-only am-u-md-6"></div>
                                        </div>
                                        <div class="am-g am-margin-top">
                                            <div class="am-u-sm-4 am-u-md-2 am-text-right">
                                                <button type="submit" class="am-btn am-btn-primary">编辑分类</button>
                                            </div>
                                        </div>
                                        <br>
                                    </form>
